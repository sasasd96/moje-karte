...
function s.splimit(e,se,sp,st)
	return se:GetHandler():IsCode(1306)
end
function s.spcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsCode,1306),tp,LOCATION_MZONE,0,1,nil)
...
function s.lvfilter(c,e,tp)
	return c:IsCode(1304) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
