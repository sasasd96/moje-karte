...
s.listed_names={80887952,17286057} --Helios Duo Megistus, Helios Trice Megistus

function s.costfilter(c,e,tp)
	return c:IsCode(80887952) and (c:IsLocation(LOCATION_HAND) or (c:IsLocation(LOCATION_MZONE) and c:IsFaceup())) and c:IsReleasable()
end
...
function s.spfilter(c,e,tp)
	return c:IsCode(17286057) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
